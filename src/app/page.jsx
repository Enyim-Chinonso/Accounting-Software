          ...
          {[
            {
              ...
              desc: "Access powerful analytics and monitor your financial performance in real time.",
            },
            {
              icon: "👥",
              title: "Customer Management",
              desc: "Keep track of all your clients, balances, and activities in one place.",
            },
            {
              icon: "💰",
              title: "Transaction Tracking",
              desc: "Easily record and manage income, expenses, and financial transactions seamlessly.",
            },
          ].map((feature, i) => (
            <div className="col-md-4" key={i}>
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center">
                  <div className="mb-3 fs-2 text-primary">{feature.icon}</div>
        ...
        <div className="container">
          ...
          <div className="row g-4">
            {[
              {
                quote:
                  "SmartBook has completely transformed how I manage my conglomerate business accounts.",
                name: "Aliko Dangote",
              ...
              <div className="col-md-4" key={i}>
                <div className="card border-0 shadow-sm h-100">
                  <div className="card-body text-center">
                    <p className="fst-italic text-secondary mb-3">“{review.quote}”</p>
      ...
      <footer className="bg-dark text-light py-5 text-center fade-up">
        <div className="container">
          <div className="mb-3 d-flex justify-content-center gap-3 fs-4">
            <a href="https://github.com/chinonsoenyim" target="_blank" className="text-light"><FaGithub /></a>

            <a href="https://www.linkedin.com/in/chinonso-enyim-1435762a1/" target="_blank" className="text-light"><FaLinkedin /></a>

            <a href="https://web.facebook.com/?_rdc=1&_rdr#" target="_blank" className="text-light"><FaFacebook /></a>
